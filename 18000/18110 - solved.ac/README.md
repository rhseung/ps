...
|---|---|---|---:|---:|---:|---:|
| <img src="https://static.solved.ac/tier_small/7.svg" width="20px" /> | 1 초 (추가 시간 없음) | 1024 MB | 65484 | 17119 | 14837 | 25.358% |
...
solved.ac
는 Sogang ICPC Team 학회원들의 알고리즘 공부에 도움을 주고자 만든 서비스이다. 지금은 서강대뿐만 아니라 수많은 사람들이 solved.ac의 도움을 받아 알고리즘 공부를 하고 있다.

![image](https://upload.acmicpc.net/93ca0eb8-56a3-4b34-bb15-281f633a0856/-/preview/)
...
\> 
2019 Sogang Programming Contest
\> 
Champion
A번

- 문제를 만든 사람: shiftpsh
- 데이터를 추가한 사람: hongjwan , sait2000
- 문제를 검수한 사람: jh05013 , kipa00
