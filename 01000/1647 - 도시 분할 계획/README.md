...
| --------------------------------------------------------------------- | --------- | ----------- | ----: | ----: | --------: | --------: |
| <img src="https://static.solved.ac/tier_small/12.svg" width="20px" /> | 2 초      | 256 MB      | 39191 | 18793 |     13635 |   49.429% |
...
- 데이터를 추가한 사람: jsong0327
- 빠진 조건을 찾은 사람: khkim6040 , kyaryunha , tmdals6718
- 문제를 만든 사람: ntopia
